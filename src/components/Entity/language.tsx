...
function Language({ id, name, code, is_active }: LanguageProps) {
  return (
    <div className="flex items-center p-4 bg-gray-100 rounded-lg shadow-md hover:bg-gray-200 my-2">
      ...
      <span className="ml-4 text-gray-500 font-semibold">Code:</span>
      <span className="ml-2 text-blue-600">{code}</span>
